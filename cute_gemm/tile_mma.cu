...
// 
// (https://github.com/NVIDIA/cutlass/issues/1028) // explain the atom
// https://docs.nvidia.com/cutlass/media/docs/cpp/cute/0t_mma_atom.html#tiledmmas // explain the atom
//
...
int main(int argc, const char** argv)
{
    ...
    // 
    // Configure Atom and tiled MMA.
    // An atom in CUTLASS and CuTe is defined as the smallest number of threads and data 
    // that must participate together to execute an architecture intrinsic copy/math operation.
    //
